 ...
 */
public class MobiMeter extends MIDlet implements CommandListener {

    //the debug flag, same can be achieved using preprocessing
    //but its ok for this small app
    ...
    public void commandAction(Command command, Displayable displayable) {
        ...
        if (displayable == getInputForm().getForm()) {
            ...
            if (command == getReportForm().getExitCommand()) {
                ...
                exitMIDlet();
                // write post-action user code here
            } else if(command == getReportForm().getAboutCommand()) {
                // write pre-action user code here
                switchDisplayable(getAboutAlert(), getReportForm().getForm());
                // write post-action user code here
            }
        }
        // write post-action user code here
    ...
    private Alert getAboutAlert() {
        if(aboutAlert == null) {
            aboutAlert = new Alert("Credits:", "http://www.himanshug.info/", null, AlertType.INFO);
